...
* Gabber may share personal data with businesses outside of the EU in order to provide a better service. Gabber is hosted on [Digital Ocean](http://digitalocean.com/), uses [Amazon Web Services](https://aws.amazon.com/) for storing data securely and [SendGrid](https://sendgrid.com/) to distribute emails.
