...
* TalkFutures is a public service and anything you post may become available to anyone around the world who views the website. 
* Audio conversations captured using the TalkFutures mobile applications are available to project administrators and research staff of TalkFutures projects. Participants of the conversation can select who else they want to have access to their conversation prior to recording, and can modify their initial consent at any time through the website.
* TalkFutures has been developed at Open Lab, Newcastle University as a research project. Any information we collect from you will be stored securely in the **EU** and may be subject to processing. We often publish findings based on user activity, which will never contain information that could be used to individually identify you.
* When you use TalkFutures, even if you are just browsing through the content, we receive some personal information about you like your IP address and the type of device you are using. When you sign up you may be asked for additional information such as your fullname and email address, which we use to keep your account secure and improve the experience for yourself and other users.
