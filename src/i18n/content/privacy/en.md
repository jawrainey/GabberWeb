# Key Points
Your privacy is important to us and we believe you should always know what data we collect from you and the ways that we use it. Our aim is to give you meaningful control and empower you to make the best decisions about the information you share with us.

**Here are some key points from the policy, but please read the full document:**

* Gabber is a public service and anything you post may become available to anyone around the world who views the website. 
* Audio conversations captured using the Gabber mobile applications are available to project administrators and research staff of Gabber projects. Participants of the conversation can select who else they want to have access to their conversation prior to recording, and can modify their initial consent at any time through the website.
* Gabber has been developed at Open Lab, Newcastle University as a research project. Any information we collect from you will be stored securely in the **EU** and may be subject to processing. We often publish findings based on user activity, which will never contain information that could be used to individually identify you.
* When you use Gabber, even if you are just browsing through the content, we receive some personal information about you like your IP address and the type of device you are using. When you sign up you may be asked for additional information such as your fullname and email address, which we use to keep your account secure and improve the experience for yourself and other users.
...
* Gabber may share personal data with businesses outside of the EU in order to provide a better service. Gabber is hosted on [Digital Ocean](http://digitalocean.com/), uses [Amazon Web Services](https://aws.amazon.com/) for storing data securely, uses [Google Firebase](https://firebase.google.com/) for logging mobile application interactions and crashes, and [SendGrid](https://sendgrid.com/) to distribute emails.
* Gabber complies with GDPR and any external services that are not based in the EU comply with the EU-US Privacy Shield Frameworks as set forth by the U.S. Department of Commerce regarding the collection, use, and retention of personal data from the EU and Switzerland. For more information about the Privacy Shield generally, and to view the certificates online, please visit [https://www.privacyshield.gov](https://www.privacyshield.gov).
